...
const ZingenVoorbijPolarisatie = ({act}) => {
  return (
    <div className="w-1/2 flex flex-col justify-between border-l border-gray-400 mt-4 pl-6 max-socials:border-0 max-socials:pl-0 max-socials:w-full">
      <div className="prose-lg py-4 max-xxsm:w-full">
        ...
        <p className="my-2">
          ...
          zaterdagmiddag 5 april van 14.30-17.30 uur, in de Muiderkerk een middag
          over ‘Zingen voorbij polarisatie’. Bestemd voor kerkmusici, koren,
          liturgiecommissies, voorgangers en wie er maar van kerkmuziek houdt.
          De één houdt van opwekking, de ander van gregoriaans, de een van
          Goudimel, de ander van Oosterhuis. Sluiten de verschillende genres
          ...
          door Rijk van Ark en Flip Noordam.<br />Voor informatie en aanmelding: klik op "Lees meer" in onderstaande aankondiging.
          <br />
