...
const Header = ({showMenuOverlay}) => {
  ...
  const style =
    "max-socials:justify-end max-socials:mr-8 max-title:hidden";
   ...
   <div className="w-full min-h-full max-w-[2000px] relative">
     <div
       ...
       <div
         ...
         <div
           className="cursor-pointer min-h-full flex items-center justify-center title:hidden mr-8 max-xxsm:mr-4 max-xxxsm:mr-2"
