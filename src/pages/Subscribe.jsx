...
const Subscribe = () => {
  ...
  // In archief, inschrijving verlopen, code niet meer nodig!
  //  let title;
  //  let costs;
  ...
  const contributionTexts = {
    lezing: (
      <span>
        Per lezing vragen we van de deelnemers, die het kunnen betalen, een
        bijdrage van € 15,-.
        <br />
    ...
    <div className="w-full h-auto flex justify-center flex-col mt-[190px] pr-8 pl-12 max-sm:pr-2 max-sm:pl-6 max-sm:mt-[160px] pb-20 max-xxsm:pl-2">
      <div
        className="contact_form h-auto w-full max-w-[580px] mx-auto flex flex-col justify-start items-center 
         bg-white px-16 py-10 rounded-xl max-sm:px-4 max-sm:py-4 relative"
      >
